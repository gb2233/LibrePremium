...
public class MapDataPacket extends AbstractPacket {
    ...
    public static final List<ProtocolIdMapping> MAPPINGS = Arrays.asList(
        rangedIdMapping(MINECRAFT_1_8, MINECRAFT_1_8, 0x34),
        rangedIdMapping(MINECRAFT_1_9, MINECRAFT_1_12_2, 0x24),
        ...
        rangedIdMapping(MINECRAFT_1_19, MINECRAFT_LATEST, 0x24)
    );
